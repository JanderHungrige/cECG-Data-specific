TEXT_ONLY=1;
AVERAGE_GRAPHS=0;
timeSamp=[1:length(projectedECG)]./500./60+initOffset/60; % 500 was 250
...
motionUp=repmat(motionIn,WINDOW_SIZE/16,1);
motionUp=motionUp(:)';
...
% sortedCombo(2,Rel_Indicator(min(ceil(sortedCombo(2,:)/(numberNewSamples/16)),numel(Rel_Indicator)))==sortedCombo(1,:));
% sortedCombo
