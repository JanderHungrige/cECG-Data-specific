...
ADULT=0;
Body=1;
%The follwoing directory is where you're saving processed files;
savingdir=dataSetpath{3};

% dataSet{1} = 'V:\cECG study\20120704_test4\20120704_131442'; numFiles_dataSet(1)=1; STARTtime_dataSet(1)=0; ENDtime_dataSet(1)=9;
% dataSet{2} = 'V:\cECG study\20120704_test4\20120704_133713'; numFiles_dataSet(2)=1; STARTtime_dataSet(2)=0; ENDtime_dataSet(2)=12;
% dataSet{3} = 'V:\cECG study\20120704_test4\20120704_135812'; numFiles_dataSet(3)=1; STARTtime_dataSet(3)=0; ENDtime_dataSet(3)=16;
% dataSet{4} = 'V:\cECG study\20120704_test4\20120704_143614'; numFiles_dataSet(4)=2; STARTtime_dataSet(4)=0; ENDtime_dataSet(4)=45;
% dataSet{5} = 'V:\cECG study\20120704_test4\20120704_143614'; numFiles_dataSet(5)=3; STARTtime_dataSet(5)=47; ENDtime_dataSet(5)=Inf;
% dataSet{6} = 'V:\cECG study\20120704_test4\20120704_182322'; numFiles_dataSet(6)=1; STARTtime_dataSet(6)=0; ENDtime_dataSet(6)=Inf;

% dataSet{1} = 'D:\Philips DATA\20120704_test4\20120704_131442'; numFiles_dataSet(1)=1; STARTtime_dataSet(1)=0; ENDtime_dataSet(1)=9;
% dataSet{2} = 'D:\Philips DATA\20120704_test4\20120704_133713'; numFiles_dataSet(2)=1; STARTtime_dataSet(2)=0; ENDtime_dataSet(2)=12;
% dataSet{3} = 'D:\Philips DATA\20120704_test4\20120704_135812'; numFiles_dataSet(3)=1; STARTtime_dataSet(3)=0; ENDtime_dataSet(3)=16;
% dataSet{4} = 'D:\Philips DATA\20120704_test4\20120704_143614'; numFiles_dataSet(4)=2; STARTtime_dataSet(4)=0; ENDtime_dataSet(4)=45;
% dataSet{5} = 'D:\Philips DATA\20120704_test4\20120704_143614'; numFiles_dataSet(5)=3; STARTtime_dataSet(5)=47; ENDtime_dataSet(5)=Inf;
% dataSet{6} = 'D:\Philips DATA\20120704_test4\20120704_182322'; numFiles_dataSet(6)=1; STARTtime_dataSet(6)=0; ENDtime_dataSet(6)=Inf;

% dataSet{1} = 'D:\Philips DATA\20120704_test4\20120704_182322'; numFiles_dataSet(1)=1; STARTtime_dataSet(1)=0; ENDtime_dataSet(1)=16;
% dataSet{1} = 'Y:\cECG study\Backup to play around\20120704_test4\20120704_182322'; numFiles_dataSet(1)=1; STARTtime_dataSet(1)=0; ENDtime_dataSet(1)=16;
% dataSet{1} = 'D:\cECG study\20120704_test4\20120704_182322'; numFiles_dataSet(1)=1; STARTtime_dataSet(1)=0; ENDtime_dataSet(1)=16;

%dataSet{1} = 'D:\Philips DATA\20120704_test4\20120704_143614'; numFiles_dataSet(1)=1; STARTtime_dataSet(1)=0; ENDtime_dataSet(1)=15;
%dataSet{1} = 'D:\Philips DATA\20120712_test7\20120712_110304'; numFiles_dataSet(1)=1; STARTtime_dataSet(1)=0; ENDtime_dataSet(1)=50;

%AnnotationDirectory = 'V:\cECG study\Case Record Forms Clinical Study\20120717_test8\Labels\';
%dataSet{2} = 'D:\Philips DATA\20120704_test4\20120704_131442'; numFiles_dataSet(2)=1; STARTtime_dataSet(2)=8; ENDtime_dataSet(2)=12;


% if ~exist('dataSet','var')
%     dataSet{1} = uigetdir(cd, 'Select data folder (binary files)');
%     STARTtime_dataSet(1)=input('Enter the starting time (in minutes from the beginning of the ECG file)(default=0=beginning of dataset):');
%     if isempty(STARTtime_dataSet(1))
%         STARTtime_dataSet(1)=0;
%     end
%     ENDtime_dataSet(1)=input('Enter the ending time (in minutes from the beginning of the ECG file)(default=Inf=end of dataset):');
%     if isempty(ENDtime_dataSet(1))
%         ENDtime_dataSet(1)=Inf;
%     end
%     ADULT=input('Matress configuration and HR limits? (adult=1, baby(default)=0):');
%     if isempty(ADULT)
%         ADULT=0;
%     end
%     Body=input('Body position? (prone(default)=1, supine=0):');
%     if isempty(Body)
%         Body=1;
%     end
%     numFiles_dataSet(1)=input('Number of consecutive ECG binary files? (default=1):');
%     if isempty(numFiles_dataSet(1))
%         numFiles_dataSet(1)=1;
%     end
% end
...
for index_dataset=1:numel(dataSet)
    ...
    WINDOW_SIZE=8000; % in samples; min 352 (delay of pre-resampling filter) and max 16000 (buffer size) for 8000Hz, (Note: RRmin = 250bpm = 1900 samples @ 8000Hz)
