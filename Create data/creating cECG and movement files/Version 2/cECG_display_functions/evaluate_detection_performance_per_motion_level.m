...
fprintf(fid, '\n');
results.wholeData=[totalTime/FS/60,availableHRTime/FS/60, countLong, maxLength, meanLength, PPV*100, SEN*100, ERROR, saved_ilength];
...
motion=motionUp(round(sortedCombo(2,:)-initOffset*FS)); %=motionUp((sortedComboUp(2,:)~=0)); 
...
if TP>1 || FP>1 || FN>1
    ...
    results.noMotion=[totalTime/FS/60,availableHRTime/FS/60, countLong, maxLength, meanLength, PPV*100, SEN*100, ERROR, saved_ilength];
else
...
if TP>1 || FP>1 || FN>1
    ...
    results.lowMotion=[totalTime/FS/60,availableHRTime/FS/60, countLong, maxLength, meanLength, PPV*100, SEN*100, ERROR, saved_ilength];
else
...
if TP>1 || FP>1 || FN>1
    ...
    fprintf(fid, '\n');
    results.highMotion=[totalTime/FS/60,availableHRTime/FS/60, countLong, maxLength, meanLength, PPV*100, SEN*100, ERROR, saved_ilength];
else
...
if TP>1 || FP>1 || FN>1
    ...
    fprintf(fid, '\n');
    results.intervention=[totalTime/FS/60,availableHRTime/FS/60, countLong, maxLength, meanLength, PPV*100, SEN*100, ERROR, saved_ilength];
else
...
if TP>1 || FP>1 || FN>1
    ...
    fprintf(fid, '\n');
    results.ghosts=[totalTime/FS/60,availableHRTime/FS/60, countLong, maxLength, meanLength, PPV*100, SEN*100, ERROR, saved_ilength];
else
...
if TP>1 || FP>1 || FN>1
    ...
    fprintf(fid, '\n');
    results.ignored=[totalTime/FS/60,availableHRTime/FS/60, countLong, maxLength, meanLength, PPV*100, SEN*100, ERROR, saved_ilength];
else
