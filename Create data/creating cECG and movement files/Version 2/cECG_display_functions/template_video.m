function [fig, ha, el] = template_video
...
ha(3) = axes('Parent',fig,'YTick',[],'XTick',[],...
    'Position',[0.5 0.699264705882353 0.4046+0.05 0.2157]);
box(ha(3),'on');
...
% Create axes
ha(4) = axes('Parent',fig,'YTick',[],'XTick',[],...
    'Position',[0.5 0.399632352941176 0.4046+0.05 0.2157]);
box(ha(4),'on');
