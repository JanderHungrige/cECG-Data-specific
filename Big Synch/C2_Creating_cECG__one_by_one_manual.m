...
patient_folder_DAQ='20120719_test9';
DAQ_folder='20120719_153405';
...
saving_RAW_cECG=0; % Used in read_data from Serteyn, Aline <aline.serteyn@philips.com>; Use that to save the RAW cECG for the algorythm from Guy Warmerdam (G.J.J.Warmerdam@tue.nl) 
jansway=0; % which way of caluclating the cECG. 1= Jan, all at once; 0= ALine, original In Bulks of Windowssize
