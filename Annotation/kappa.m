...
global m f x w alpha k sek
k=[]; % as k is global, we clear it before use as a security measure.
sek=[];
% B=load('Babieannotation.mat');
% x=B.Babies.Babie4;
